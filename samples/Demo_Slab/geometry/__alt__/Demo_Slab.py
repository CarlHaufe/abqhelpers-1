# -*- coding: utf-8 -*-
# ------------------------------------------------------------------------------
# Description:  Four Point Bending Test on Single Span Concrete Beam
...
abq_path = 'C:/temp\GitHub_ch/abqhelpers/'
...
# Delete Mesh
# ----------------
# abq_mesh.delete_mesh_all_active_instances(model)
...
# Create Job
abq_job.create_job(model, modelName, 4)
